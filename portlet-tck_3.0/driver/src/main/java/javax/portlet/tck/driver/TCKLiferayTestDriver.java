...
//               } else {
//                  System.out.println("test: WARNING: the element is right here but we are switching ... getExclusive ...");
//               }
               wels = getExclusive();
            }
            ...
            if (wels.isEmpty()) {
//               if (hadToGet) {
//                  System.out.println("test: wels.isEmpty() WARNING: already hadToGet but ... getExclusive again ... wrong portlet.");
//               }
//               else {
//                  System.out.println("test: wels.isEmpty() ... getExclusive wrong portlet.");
//               }
               wels = getExclusive();
            }
...
//            System.out.println("test: NOT exclusive ...");
...
//         System.out.println("test:   wasExclusive = " + wasExclusive);
//         System.out.println("test: stillExclusive = " + stillExclusive);
//         System.out.println("test:       hadToGet = " + hadToGet);
//         System.out.println("test:      exclusive = " + exclusive);
